#!/usr/bin/env node
// Build slides-fr.json — Week 3, Post 1 FR mirror — "Une matinee avec un agent ADL"
...
const s1 = page({
  ...
  inner: `
    ${stamp()}
    <div class='micro' style='background:rgba(244,195,23,0.14);color:#f4c317'>Donnee Terrain · Travail de Quartier</div>
    <div style='display:flex;align-items:center;gap:48px;margin-top:72px'>
      ...
      <div style='display:flex;flex-direction:column;gap:14px'>
        <div style='font-weight:700;font-size:22pt;letter-spacing:0.12em;text-transform:uppercase;color:rgba(242,246,250,0.75)'>Une matinee<br/>avec ADL</div>
    ...
    <div style='margin-top:96px'>
      <div style='font-weight:700;font-size:88px;line-height:1.02;letter-spacing:-0.015em'>Une matinee<br/>avec un agent<br/>ADL.</div>
      <div style='font-weight:500;font-size:26pt;line-height:1.35;color:rgba(242,246,250,0.72);margin-top:28px;max-width:880px'>Cinq slides. Trois horaires. Une vraie tournee a Bonamoussadi — et ce que paie le travail.</div>
    </div>
...
const s2 = page({
  ...
  inner: `
    ${stamp()}
    <div class='micro' style='background:rgba(200,107,74,0.14);color:#c86b4a'>La Tournee</div>
    ...
    <div style='font-weight:700;font-size:64px;line-height:1.04;letter-spacing:-0.01em;margin-top:24px'>A pied dans<br/>Bonamoussadi.</div>
    <div style='font-weight:500;font-size:26pt;line-height:1.35;color:rgba(15,43,70,0.78);margin-top:24px;max-width:920px'>Trois arrets sur la tournee : une pharmacie, une station-service, un kiosque mobile money.</div>
    <div style='display:flex;gap:14px;margin-top:32px;flex-wrap:wrap'>
      <div style='padding:12px 20px;border-radius:14px;background:#0f2b46;color:#f2f6fa;font-weight:600;font-size:16pt'>Pharmacie</div>
      <div style='padding:12px 20px;border-radius:14px;background:#c86b4a;color:#fff8f4;font-weight:600;font-size:16pt'>Station-service</div>
    ...
    <div style='margin-top:auto;font-weight:500;font-style:italic;font-size:22pt;color:rgba(15,43,70,0.6)'>« Pas de mallette. Pas de siege social. Juste le quartier. »</div>
...
const s3 = page({
  ...
  inner: `
    ${stamp()}
    <div class='micro' style='background:rgba(76,124,89,0.18);color:#2f5438'>La Capture</div>
    <div class='accent-bar' style='background:#4c7c59'></div>
    <div class='timestamp' style='color:#4c7c59;margin-top:8px'>09:02</div>
    <div style='font-weight:700;font-size:64px;line-height:1.04;letter-spacing:-0.01em;margin-top:24px'>Premiere capture.</div>
    <div style='font-weight:500;font-size:26pt;line-height:1.35;margin-top:24px;max-width:920px'>Le GPS verrouille. La camera declenche. L'EXIF horodate. La file hors-ligne garde tout si le reseau coupe.</div>
    <div style='display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:36px;max-width:920px'>
      <div style='padding:24px;border-radius:20px;background:#ffffff;border:2px solid rgba(76,124,89,0.25)'>
        <div style='font-weight:700;font-size:14pt;letter-spacing:0.08em;text-transform:uppercase;color:#4c7c59'>Verrou GPS</div>
        <div style='font-weight:700;font-size:22pt;margin-top:8px;line-height:1.2'>Dans la zone</div>
      </div>
      <div style='padding:24px;border-radius:20px;background:#ffffff;border:2px solid rgba(76,124,89,0.25)'>
        <div style='font-weight:700;font-size:14pt;letter-spacing:0.08em;text-transform:uppercase;color:#4c7c59'>Photo + EXIF</div>
        <div style='font-weight:700;font-size:22pt;margin-top:8px;line-height:1.2'>Heure · Appareil</div>
      </div>
      <div style='padding:24px;border-radius:20px;background:#ffffff;border:2px solid rgba(76,124,89,0.25)'>
        <div style='font-weight:700;font-size:14pt;letter-spacing:0.08em;text-transform:uppercase;color:#4c7c59'>File hors-ligne</div>
        <div style='font-weight:700;font-size:22pt;margin-top:8px;line-height:1.2'>Tient en 2G</div>
      </div>
      <div style='padding:24px;border-radius:20px;background:#ffffff;border:2px solid rgba(76,124,89,0.25)'>
        <div style='font-weight:700;font-size:14pt;letter-spacing:0.08em;text-transform:uppercase;color:#4c7c59'>Sync auto</div>
        <div style='font-weight:700;font-size:22pt;margin-top:8px;line-height:1.2'>Au retour reseau</div>
      </div>
    </div>
...
const s4 = page({
  ...
  inner: `
    ${stamp()}
    <div class='micro' style='background:rgba(244,195,23,0.28);color:#0f2b46'>Le Resultat</div>
    <div class='accent-bar' style='background:#f4c317'></div>
    <div class='timestamp' style='color:#c86b4a;margin-top:8px'>11:30</div>
    <div style='font-weight:700;font-size:64px;line-height:1.04;letter-spacing:-0.01em;margin-top:24px'>Le score de<br/>confiance monte.</div>
    <div style='font-weight:500;font-size:26pt;line-height:1.35;color:rgba(15,43,70,0.78);margin-top:24px;max-width:920px'>Trois points passent la revue avant midi. La serie tient. Les XP s'accumulent. Un travail verifie, reconnu vite.</div>
    <div style='margin-top:40px;padding:32px;border-radius:24px;background:#0f2b46;color:#f2f6fa;max-width:940px'>
      <div style='font-weight:700;font-size:15pt;letter-spacing:0.08em;text-transform:uppercase;color:#f4c317'>Le pipeline ADL</div>
      <div style='font-weight:600;font-size:24pt;line-height:1.3;margin-top:12px'>GPS + EXIF + score de risque + niveau de confiance — chaque soumission est auditee avant d'apparaitre sur la carte publique.</div>
    </div>
    <div style='margin-top:auto;font-weight:500;font-style:italic;font-size:22pt;color:rgba(15,43,70,0.65)'>« Travail verifie, reconnu vite. »</div>
...
const s5 = page({
  ...
  inner: `
    ${stamp()}
    <div class='micro' style='background:rgba(244,195,23,0.35);color:#0f2b46'>Beta · Postulez</div>
    <div style='margin-top:56px'>
      <div style='font-weight:700;font-size:80px;line-height:1.02;letter-spacing:-0.015em'>Travail de<br/>terrain — paye<br/>en vraies<br/>recompenses.</div>
      <div style='font-weight:500;font-size:26pt;line-height:1.35;margin-top:28px;color:rgba(15,43,70,0.82);max-width:900px'>Beta ouverte pour les agents de terrain a Douala. Si vous connaissez votre quartier — postulez cette semaine.</div>
    </div>
    ...
    <div style='margin-top:auto;display:flex;flex-direction:column;gap:16px'>
      ...
      <div style='font-weight:500;font-size:19pt;color:rgba(15,43,70,0.72)'>On repond dans la semaine. Enregistrez. Partagez avec un proche a Douala.</div>
    </div>
  `,
});
